...
#h_pool1=tf.nn.dropout(h_pool1,keep_prob=1.0)
## conv2 layer ##
...
#h_pool2 =tf.nn.dropout(h_pool2,keep_prob=1.0)

W_conv3 = weight_variable([3,3, 128, 64]) # patch 5x5, in size 32, out size 64
